...
{% macro default__required_docs(models) %}
    ...
    {% if not var("running_integration_tests", false) is true %}{{ log(start_msg, info=true) }}{% endif %}
    ...
    {% else %}
        ...
        {% if not var("running_integration_tests", false) is true %}{{ log(result, info=true) }}{% endif %}
